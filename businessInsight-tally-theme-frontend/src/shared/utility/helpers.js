...
export const employRole = ['companyAdmin', 'organizationAdmin']
...
export const blogs = [
  {
    ...
    readTime: '3 Min Read',
    description:
      'The Dynamic Landscape Of Business Analytics: Data Isn’t Just A Commodity—It’s The Oxygen That Drives Innovation. As Organizations Strive To Stay',
    image: blogImg1
  },
  {
    id: 2,
    title: 'Driving Growth Through Data',
    author: 'Dasteen',
    date: 'Jan 10, 2024',
    readTime: '3 Min Read',
    description:
      "In Today's Rapidly Evolving Business Landscape, The Data Revolution Is Reshaping The Way Organizations Operate. From Decision-Making To Strategy",
    image: blogImg2
  },
  {
    id: 3,
